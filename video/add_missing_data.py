...
from constants.paths import OUTPUT_INTERPOLATED_RESULTS, OUTPUT_RESULTS
...
def create_interpolate_date():
    ...
    with open(OUTPUT_INTERPOLATED_RESULTS, "w", newline="") as file:
