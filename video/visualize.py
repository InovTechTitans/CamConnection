...
from constants.paths import (INPUT_SAMPLE, OUTPUT_GENERATED_VISION_RESULTS,
                             OUTPUT_INTERPOLATED_RESULTS)
...
def show_vizualization():
    results = pd.read_csv(OUTPUT_INTERPOLATED_RESULTS)

    # load video
    video_path = INPUT_SAMPLE
    ...
    out = cv2.VideoWriter(OUTPUT_GENERATED_VISION_RESULTS, fourcc, fps, (width, height))
